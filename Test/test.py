...
def create():
    db = pymysql.connect(host='222.223.239.147', user='root', password='Xinboway@803', port=3307,database='test_1')  # 连接数据库
...
def insert(value):
    db = pymysql.connect(host="222.223.239.147", user="root", password="Xinboway@803", port=3307,database="test_1")
...
soup = BeautifulSoup(res.text, 'html_test.parser')
